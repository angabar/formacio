          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  // LESSON: Las keys son necesarias para vincular el estado de
                  // un widget con el elemento del widget en si, en caso de no
                  // usarlas la actualización de un widget y su elemento
                  // vinculado no van de la mano, haciendo que algunas cosas no
