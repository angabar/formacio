...
export default {
    ...
    handleMouseInput(o) {
        switch (o.element) {
            case o.dom.hue:
                if (o.attribute === "value") {
                    ...
                    o.dom.satbright.backgroundcolor = Color.RGBtoHex(
                        Color.HSVtoRGB(o.model.color.hue, 1, 1),
                    );
                    o.dom.transparency.backgroundcolor = Color.RGBtoHex(
                        Color.HSVtoRGB(o.model.color.hue, 1, 1),
                    );
                } else {
            ...
            case o.dom.transparency:
                if (o.attribute === "value") {
                    o.model.color.alpha =
                        100 -
                        this.formatTextInput(o.element[o.attribute], 0, 100);
                    o.dom.textInputA.value = this.formatTextInput(
                        o.model.color.alpha,
                        0,
                        100,
                    );
        ...
        o.model.color.rgb = Color.HSVtoRGB(
            o.model.color.hue,
            o.model.color.saturation,
            o.model.color.brightness,
        );
        ...
        o.dom.textInputR.value = this.formatTextInput(
            o.model.color.rgb.r,
            0,
            255,
        );
        o.dom.textInputG.value = this.formatTextInput(
            o.model.color.rgb.g,
            0,
            255,
        );
        o.dom.textInputB.value = this.formatTextInput(
            o.model.color.rgb.b,
            0,
            255,
        );
    ...
    handleRGBA(o) {
        if (o.element === o.dom.textInputA) {
            o.model.color.alpha = this.formatTextInput(
                o.dom.textInputA.value,
                0,
                100,
            );
    ...
    shouldIgnoreChange(o) {
        if (
            o.model.ignoreNextChange &&
            o.model.ignoreNextChange.has(o.element)
        ) {
